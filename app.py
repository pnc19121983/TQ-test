...
# Thay đổi ID dưới đây thành ID file Excel của bạn
file_id = '1fzUxf9l29TU8ZtQvjHui3cQ6slTNs2FF'  # <-- THAY BẰNG ID THẬT
...
try:
    ...
    st.title("📊 Phân tích dữ liệu từ Google Drive")

    st.subheader("📄 Xem dữ liệu gốc:")
    st.dataframe(df)

    # Có thể xử lý thêm: lọc, biểu đồ, phân tích,...
